...
import org.milaifontanals.biblioteca.persistence.BPFitxerBinariManualDos;
...
public class Test {
    public static void main(String []args){
        ...
        String fileName = "bibliotecaDos.dat";
        
        BPFitxerBinariManualDos.saveBiblioteca(b, fileName);
        
        System.out.println("\nGuardat correctament!");
        
        BibliotecaTS b2 ;
        
        b2 = (BibliotecaTS) BPFitxerBinariManualDos.loadBiblioteca(fileName);
