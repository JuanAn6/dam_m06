...
import org.milaifontanals.biblioteca.persistence.BPFitxerBinariSerialitzat;
...
public class Test {
    public static void main(String []args){
        ...
        BPFitxerBinariSerialitzat.saveBiblioteca(b);
        
        System.out.println("\nGuardat correctament!");
        
        BibliotecaTS b2 ;
        
        b2 = (BibliotecaTS) BPFitxerBinariSerialitzat.loadBiblioteca();
