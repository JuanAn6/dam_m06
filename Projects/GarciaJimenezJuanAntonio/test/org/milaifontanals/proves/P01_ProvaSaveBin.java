...
public class P01_ProvaSaveBin {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ProvaSaveBIN");
        System.out.println("Llista de flotes a enregistrar:");
        for (Fleet f : ll) {
            System.out.println("\t"+f);
        }
        try {
            FleetListPersistence.saveFleetListBin(ll,"llistaFlotes.bin");
        } catch (FleetListPersistenceException ex) {
            System.out.println("Error en enregistrar el fitxer binari");
            ex.printStackTrace();
        }
